...
setup = ff.Setup_Interfacial_Optimization('NO2.in')
# 2 end 

# 3  Let's read the data

al = ff.al_help()
al.log_to_xyz('dataNO2', 'dataNO2xyz')
path_xyz = 'dataNO2xyz'
...
data = data [ data['Energy'] <0.01]

# 5 solve the model
t1 = perf_counter()    
data, current_costs, setup = al.solve_model(data,setup)
