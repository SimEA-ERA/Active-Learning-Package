...
bsize=200
Niters=21
iexist=0   # if you have the data/L0, .... Lcontin then you can restart the learning process by setting here
contin=0   # if you have the data/L0, .... Lcontin then you can restart the learning process by setting here
sigma=0.02
Ttarget=500
