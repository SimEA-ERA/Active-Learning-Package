...
m1 = ff.TestPotentials('Morse',params,1,10,0.0001,ignore_high_u=100,plot=False)
...
if True:
    ...
    m2 = ff.TestPotentials('Morse',params,1,5,0.0001,ignore_high_u=100)
    ...
    m3 = ff.TestPotentials('Morse',params,1,5,0.0001,ignore_high_u=100)
